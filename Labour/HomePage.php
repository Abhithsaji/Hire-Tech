...
?>
 <?php
	...
	$selqry="select count(*) as count from tbl_wishlist wi inner join tbl_user u on u.user_id=wi.user_id inner join tbl_labour w on w.labour_id=wi.labour_id  where w.labour_id='".$_SESSION["labourid"]."'";

$roww=$conn->query($selqry);
...
<html lang="en">
    <head>
        <meta charset="utf-8">
        <title>HIRE TECH</title>        <meta content="width=device-width, initial-scale=1.0" name="viewport">
        ...
        <div class="wrapper">
                        ...
                        <div class="col-lg-4 col-md-12">
                            <div class="logo">
                                <a href="Template/Main/index.html">
                                    <h2 style="font-weight:900">HIRE TECH</h2>
                                </a>
                            </div>
                        </div>
                    ...
                    <nav class="navbar navbar-expand-lg bg-dark navbar-dark">
                        ...
                        <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                           <div class="navbar-nav mr-auto">
                                ...
                                <div class="nav-item dropdown">
                                    <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">Message</a>
                                    <div class="dropdown-menu">
                                        <a href="Complaint.php" class="dropdown-item">Complaint</a>
                                        <a href="Feedback.php" class="dropdown-item">Feed Back</a>
                                    </div>
                                </div>
                                <a href="WorkPost.php" class="nav-item nav-link">Post</a>
                                <a href="WorkRequest.php" class="nav-item nav-link">Request</a>
                                <a href="WorkGallery.php" class="nav-item nav-link">Gallery</a>
                                                                
                                <a href="Complaint.php" class="nav-item nav-link">Complaint</a>
                                 <a href="../Logout.php" class="nav-item nav-link">Logout</a>
                            </div>
                            <div class="ml-auto">
                                <a class="btn" href="#"><span align="center" style="color:red">&#9829;</span> <?php echo $dataw["count"]; ?></a>
                            </div>
                        </div>
                    </nav>
                </div>
            ...
            <div id="carousel" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-item active">
                        <img src="../Template/Main/img/bg_1.jpg" alt="Carousel Image">
                        <div class="carousel-caption">
                        <p class="animated fadeInRight">Welcome</p>
                            <h1 class="animated fadeInLeft"><?php echo $_SESSION["labourname"]; ?></h1>
                        </div>
                    </div>
                    ...
                    <div class="carousel-item">
                        ...
                        <div class="carousel-caption">
                        <p class="animated fadeInRight">Welcome </p>
                        <p class="animated fadeInRight">Labour</p>
                            <h1 class="animated fadeInLeft"><?php echo $_SESSION["labourname"]; ?></h1>
                        </div>
                    </div>
                        ...
                        <div class="col-lg-4 col-md-12">
                            <div class="feature-item">
                                ...
                                <div class="feature-text">
                                    <h3>Expert labour</h3>
                                    <p>We provide high expeienced labours</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-12">
