        ...
        <div class="wrapper">
                    ...
                    <nav class="navbar navbar-expand-lg bg-dark navbar-dark">
                        ...
                        <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                           <div class="navbar-nav mr-auto">
                                ...
                                <a href="SearchWork.php" class="nav-item nav-link">Work</a>
                                <a href="SearchLabour.php" class="nav-item nav-link">Labour</a>
                                <a href="MyBooking.php" class="nav-item nav-link">Booking</a>
                                <a href="MyRequest.php" class="nav-item nav-link">Request</a>
            ...
            <div id="carousel" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-item active">
                        ...
                        <p class="animated fadeInRight">Welcome User</p>
                            <h1 class="animated fadeInLeft"><?php echo $_SESSION["username"]; ?></h1>
                        </div>
                    </div>
                    ...
                    <div class="carousel-item">
                        ...
                        <div class="carousel-caption">
                        <p class="animated fadeInRight">Welcome</p><br>
                        <p class="animated fadeInRight">User</p>
                            <h1 class="animated fadeInLeft"><?php echo $_SESSION["username"]; ?></h1>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 col-lg-3">
                            <div class="footer-contact">
                                ...
                                <p><i class="fa fa-envelope"></i>hiretech@example.com</p>
                        ...
                        <div class="col-md-6 col-lg-3">
                            <div class="footer-link">
                                ...
                                <a href="Template/Main/">Ceiling Works</a>
                                <a href="Template/Main/">House Renovation</a>
                                <a href="Template/Main/">Tile Setting</a>
                                <a href="Template/Main/"> Wood Carpentry</a>
