...
<form id="form1" name="form1" method="post" action="">
    <table width="605" height="122" border="1" align="center">
      <tr>
        ...
        <textarea name="txt_feedback" id="txt_feedback" cols="30" rows="10"></textarea></td>
      </tr>
      <tr>
    ...
    <table width="604" border="1" align="center">
      ...
      <?php 
      $i=0;
      $sellab="select * from tbl_user";
      $rows = $conn->query($sellab);
      while($res= $rows->fetch_assoc())
      {
	  		$uid=$res['user_id'];
	  	 	$sel ="select * from tbl_feedback where '" . $uid . "'  = '" . $_SESSION['userid'] . "'";
	  		$row = $conn->query($sel);
